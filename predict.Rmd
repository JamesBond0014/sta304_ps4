...
overall_prop$predict <- overall_prop$predict[,1] 
head(overall_prop$predict)
```

```{r}
overall_prop$vote <- if_else(overall_prop$predict >0.5, 1, 0)
```
